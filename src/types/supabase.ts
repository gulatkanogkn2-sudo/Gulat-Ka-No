    ...
    Tables: {
      profiles: {
        Row: {
          ...
          status: 'ACTIVE' | 'PENDING_VERIFICATION' | 'SUSPENDED' | 'DISABLED' | 'BANNED' | string;
          tier: string | null;
          is_manual_tier_override: boolean;
          customer_code: string | null;
          verification_status: 'VERIFIED' | 'UNVERIFIED' | 'PENDING_ID' | 'REJECTED' | string;
          qualifying_lifetime_spending_php: number;
